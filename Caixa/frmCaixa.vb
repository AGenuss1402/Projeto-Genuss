...
Public Class frmCaixa
    ...
    Private Sub btnConfirmarCaixa_Click(sender As Object, e As EventArgs) Handles btnConfirmarCaixa.Click
    ...
    Private Sub btnListaCaixas_Click(sender As Object, e As EventArgs)
